...
// func (ss *SessionStream) SetupServer(params message.Parameters) error {
// 	ssm := message.SessionServerMessage{
// 		SelectedVersion: DefaultServerVersion,
// 		Parameters:      params,
// 	}
// 	_, err := ssm.Encode(ss.Stream)
// 	if err != nil {
// 		return err
// 	}
...
func (ss *SessionStream) SendSessionUpdate(bitrate uint64) error {
