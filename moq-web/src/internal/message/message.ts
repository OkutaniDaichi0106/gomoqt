 ...
 */
export async function readFull(r: Reader, p: Uint8Array): Promise<[number, Error | undefined]> {
	let totalRead = 0;
 ...
 */
export async function writeVarint(w: Writer, num: number): Promise<[number, Error | undefined]> {
	if (num < 0) {
 ...
 * Returns number of bytes written and any error.
 */
export async function writeString(w: Writer, str: string): Promise<[number, Error | undefined]> {
 ...
 */
export async function readVarint(r: Reader): Promise<[number, number, Error | undefined]> {
 ...
 */
export async function readBytes(r: Reader): Promise<[Uint8Array, number, Error | undefined]> {
	...
	if (len > MAX_BYTES_LENGTH) {
		return [new Uint8Array(0), n1, new Error("Bytes length exceeds maximum limit")];
	}
 ...
 */
export async function readString(r: Reader): Promise<[string, number, Error | undefined]> {
 ...
 */
export async function readStringArray(r: Reader): Promise<[string[], number, Error | undefined]> {
 ...
 */
export function parseBytes(buf: Uint8Array, offset: number): [Uint8Array, number] {
 ...
 */
export function parseStringArray(buf: Uint8Array, offset: number): [string[], number] {
