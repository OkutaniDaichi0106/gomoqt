...
Deno.test("TrackPrefix", async (t) => {
	...
	await t.step(
		"isValidPrefix - should return false for invalid prefixes",
		() => {
	...
	await t.step(
		"validateTrackPrefix - should return the prefix for valid prefixes",
		() => {
	...
	await t.step(
		"validateTrackPrefix - should throw an error for invalid prefixes",
		() => {
			try {
