...
// Note: Do NOT provide Vitest-specific globals (expect/vi) here —
...
// Simple synchronous background context: returns an object whose `done`
//   // Note: no custom `expect`/`vi` shims here — tests should use Deno std asserts
//     obj[key] = spy;
//     __vi_spies.push({ obj, key, orig });
//     return spy as any;
//   },
//   restoreAllMocks() {
//     // restore spies
//     for (const e of __vi_spies) {
//       e.obj[e.key] = e.orig;
//     }
//     __vi_spies.length = 0;
//     // reset created mocks
//     for (const m of __vi_created_mocks) {
//       try { m.mockReset(); } catch (_) { /* ignore */ }
//     }
//   },
//   clearAllMocks() {
//     for (const m of __vi_created_mocks) {
...
// export * from "jsr:@okudai/golikejs";