...
func (m *MockSendStream) CancelWrite(arg0 StreamErrorCode) {
	m.ctrl.T.Helper()
...
func (m *MockReceiveStream) CancelRead(arg0 StreamErrorCode) {
	m.ctrl.T.Helper()
...
// CancelRead mocks base method.
func (m *MockStream) CancelRead(arg0 StreamErrorCode) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "CancelRead", arg0)
}
...
// CancelWrite mocks base method.
func (m *MockStream) CancelWrite(arg0 StreamErrorCode) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "CancelWrite", arg0)
}
...
func (m *MockStreamError) StreamErrorCode() StreamErrorCode {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StreamErrorCode")
	ret0, _ := ret[0].(StreamErrorCode)
	return ret0
}
