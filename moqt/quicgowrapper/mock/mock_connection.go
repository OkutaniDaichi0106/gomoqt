...
//
//	mockgen -source=../connection.go -destination=./mock_connection.go
//
...
func (mr *MockConnectionMockRecorder) AcceptStream(ctx any) *gomock.Call {
...
func (mr *MockConnectionMockRecorder) AcceptUniStream(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConnectionMockRecorder) CloseWithError(code, msg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConnectionMockRecorder) OpenStreamSync(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConnectionMockRecorder) OpenUniStreamSync(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConnectionMockRecorder) ReceiveDatagram(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockConnectionMockRecorder) SendDatagram(b any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
