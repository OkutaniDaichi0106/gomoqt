...
//
//	mockgen -source=../group_reader.go -destination=./mock_group_reader.go
//
...
func (mr *MockReceiveGroupStreamMockRecorder) CancelRead(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockReceiveGroupStreamMockRecorder) SetReadDeadline(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
